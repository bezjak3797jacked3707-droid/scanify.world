...
export default function RankPage() {
  ...
  useEffect(() => {
    async function fetchLeaderboard() {
      ...
      const sorted = (data || [])
        .map((entry) => ({ ...entry, numericValue: parseFloat(String(entry.current_value).replace(/[^0-9.]/g, "")) }))
      ...
      <div className="max-w-md mx-auto px-5 py-8 space-y-6">
        ...
        <div className="flex gap-2">
          <button
            ...
            style={{
              ...
              color: filter === "all" ? "var(--color-text-dark)" : "var(--color-text-muted)",
              border: "1px solid",
              borderColor: filter === "all" ? "var(--color-gold)" : "var(--color-border)",
            }}
          >
            All Items
          </button>
          <button
            ...
            style={{
              ...
              color: filter === "cars" ? "var(--color-text-dark)" : "var(--color-text-muted)",
              border: "1px solid",
              borderColor: filter === "cars" ? "var(--color-gold)" : "var(--color-border)",
            }}
          >
            🚗 Cars Only
          </button>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 space-y-3">
            ...
            <button onClick={() => router.push("/scan")} className="px-6 py-3 rounded-xl text-sm font-semibold tracking-wider uppercase" style={{ background: "var(--color-green)", color: "var(--color-gold)" }}>
              Be the first!
            </button>
          </div>
        ) : (
